...
name: semgrep
description: >
  Semgrep static analysis skill. Use when the user wants to scan code for vulnerabilities,
  write custom Semgrep rules, or perform taint-mode dataflow analysis for injection detection.
---
...
- [Workflow Guide](${CLAUDE_PLUGIN_ROOT}/knowledge/semgrep/workflow.md) - Complete step-by-step rule creation process
- [Quick Reference](${CLAUDE_PLUGIN_ROOT}/knowledge/semgrep/quick-reference.md) - Pattern operators and taint components
