...
Agents are specialized sub-agents that handle complex, autonomous tasks. They are invoked via the Agent tool with `subagent_type`.

## All Agents

| Agent | Plugin | Description |
|-------|--------|-------------|
| [git-conflict-specialist](ak-git/git-conflict-specialist.md) | ak-git | Merge conflict analysis and resolution |
...
| [typo3-fluid-expert](ak-typo3/typo3-fluid-expert.md) | ak-typo3 | Fluid template architecture |
| [typo3-typoscript-expert](ak-typo3/typo3-typoscript-expert.md) | ak-typo3 | TypoScript configuration and Site Sets |
